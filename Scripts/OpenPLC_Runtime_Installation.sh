...
sudo apt install -y build-essential python3-dev python3-setuptools swig git gettext-base fakeroot -y
...
# Fetch the source
echo "==============================="
echo "Install the OpenPLC runtime"
echo "==============================="
...
cd ..
echo "==============================="
echo "Cleaning up: Removing OpenPLC_v3 directory..."
echo "==============================="
rm -rf OpenPLC_v3